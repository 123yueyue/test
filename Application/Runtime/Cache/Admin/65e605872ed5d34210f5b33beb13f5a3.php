  ...
  <div id="bd">
    <div class="wrap ue-clear">
      <div class="sidebar">
        ...
        <ul class="nav">
          <li class="office current">
            <div class="nav-header"><a href="javascript:;" date-src="/tp/index.php?s=/Admin/User/home" class="ue-clear"><span>软件学院</span><i class="icon"></i></a></div>
          </li>
          <li class="gongwen">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>学院管理</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/tp/index.php?s=/Admin/Teacher/school_showList">学院查询</a></li>
              <li><a href="javascript:;" date-src="/tp/index.php?s=/Admin/Teacher/school_add">学院添加</a></li>
            </ul>
          </li>
          <li class="nav-info">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>专业管理</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/tp/index.php?s=/Admin/Teacher/profession_showList">专业列表</a></li>
              <li><a href="javascript:;" date-src="/tp/index.php?s=/Admin/Teacher/profession_add">添加专业</a></li>
            </ul>
          </li>
          <li class="konwledge">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>班级管理</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/tp/index.php?s=/Admin/Teacher/class_showList">班级列表</a></li>
              <li><a href="javascript:;" date-src="/tp/index.php?s=/Admin/Teacher/class_add">添加班级</a></li>
            </ul>
          </li>
          <li class="agency">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>学生管理</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/tp/index.php?s=/Admin/Teacher/student_showList">学生列表</a></li>
              <li><a href="javascript:;" date-src="/tp/index.php?s=/Admin/Teacher/student_test">excel导入</a></li>
            </ul>
          </li>
          <li class="email">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>管理员信息</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/tp/index.php?s=/Admin/Teacher/teacher_showList">查看管理员</a></li>
              <li><a href="javascript:;" date-src="/tp/index.php?s=/Admin/Teacher/teacher_add">添加管理员</a></li>
            </ul>
          </li>
          <li class="system">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>实践分审核</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/tp/index.php?s=/Admin/Teacher/shenhe_student">审核个人</a></li>
              <li><a href="javascript:;" date-src="/tp/index.php?s=/Admin/Teacher/shenhe_students">审核班级</a></li>
            </ul>
          </li>
        </ul>
      </div>
      <div class="content">
        ...
        -->
        <iframe name="iframe" src="/tp/index.php?s=Admin/User/home" id="iframe" width="100%" height="100%" frameborder="0"></iframe>
      </div>
    </div>
  </div>
  <div id="ft" class="ue-clear">
    <div class="ft-left"> <span>软件学院</span> <em>Designed By Data Team</em> </div>
