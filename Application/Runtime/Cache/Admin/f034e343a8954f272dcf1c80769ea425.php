...
<body>
<div class="title"><h2>班级信息添加</h2></div>
<form action="" method="post">
	<div class="main">
	    <p class="short-input ue-clear">
	    	<label>班级名称：</label>
	        <input type="text" name="cname" placeholder="班级名称" />
	    </p>
	    <p class="short-input ue-clear">
	    	<label>所属专业：</label>
	        <select name="pname">
	            <option value="0">------------------------------</option>
	            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["pname"]); ?>"><?php echo ($vol["pname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
	        </select>
	    </p>
	</div>
