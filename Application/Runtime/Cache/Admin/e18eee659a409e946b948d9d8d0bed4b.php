	...
	<table>
        ...
        <tbody>
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="operate">
                <a href="/tp/index.php/Admin/Teacher/tongguo/id/<?php echo ($vol["did"]); ?>">通过</a>
                <a href="/tp/index.php/Admin/Teacher/koufen/id/<?php echo ($vol["did"]); ?>">扣分</a>
                <a href="/tp/index.php/Admin/Teacher/zuofei/id/<?php echo ($vol["did"]); ?>">作废</a>
                </td>
