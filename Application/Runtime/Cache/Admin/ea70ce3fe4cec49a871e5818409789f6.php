	...
	<table>
        ...
        <tbody>
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                ...
                <a href="/tp/index.php?s=/Admin/Teacher/school_edit/id/<?php echo ($vol["id"]); ?>">编辑</a>
                </td>
...
$(function(){
	...
	$('.del').on('click',function(){
		...
		//带着参数跳转到del方法
		window.location.href = '/tp/index.php?s=/Admin/Teacher/school_del/id/' + id;
	});
});
...
$(function(){
	...
	$('.add').on('click',function(){
		window.location.href = '/tp/index.php?s=/Admin/Teacher/school_add';
	});
});
$(function(){
	//给编辑按钮绑定点击事件
	$('.edit').on('click',function(){
		window.location.href = '/tp/index.php?s=/Admin/Teacher/school_edit';
	});
});
