...
<div class="table-operate ue-clear">
	...
	<a href="javascript:;" class="edit">审核班级</a>
	...
	<table>
    	<thead>
        	<tr>
                ...
                <th class="totle">总实践分</th>
                <th class="operate">操作</th>
            </tr>
        </thead>
        <tbody>
        	<tr>
            	<td class="num" name = "data"><?php echo ($data['stid']); ?></td>
                <td class="name" name = "data"><?php echo ($data['stname']); ?></td>
                <td class="school" name = "sname"><?php echo ($sname); ?></td>
                <td class="profession" name = "pname"><?php echo ($pname); ?></if></td>
                <td class="class" name = "cname"><?php echo ($cname); ?></td>
                <td class="totle" name = "cname"><?php echo ($sum); ?></td>
                <td class="operate">
                <!-- <input type="checkbox" value="<?php echo ($vol["ttid"]); ?>"/> -->
                <a href="/tp/index.php/Admin/Teacher/shenhe_showList1">实践积分审核</a>
                </td>
            </tr>
        </tbody>
    </table>
...
$(function(){
	...
	$('.del').on('click',function(){
		...
		//带着参数跳转到del方法
		window.location.href = '/tp/index.php/Admin/Teacher/teacher_del/id/' + id;
	});
});
...
$(function(){
	...
	$('.add').on('click',function(){
		window.location.href = '/tp/index.php/Admin/Teacher/shenhe_student';
	});
});
$(function(){
	//给编辑按钮绑定点击事件
	$('.edit').on('click',function(){
		window.location.href = '/tp/index.php/Admin/Teacher/shenhe_students';
	});
});
