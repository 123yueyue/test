	...
	<table>
        ...
        <tbody>
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
        		<td class="num" name = "data"><?php echo ($vol['stid']); ?></td>
                <td class="name" name = "data"><?php echo ($vol['stname']); ?></td>
                <td class="school" name = "sname"><?php echo ($vol['sname']); ?></td>
                <td class="profession" name = "pname"><?php echo ($vol['pname']); ?></if></td>
                <td class="class" name = "cname"><?php echo ($vol['cname']); ?></td>
                <!-- <td class="totle" name = "cname"><?php echo ($sum); ?></td> -->
                <td class="operate">
                <!-- <input type="checkbox" value="<?php echo ($vol["ttid"]); ?>"/> -->
                <a href="/tp/index.php?s=/Admin/Teacher/shenhe_test/id/<?php echo ($vol['stid']); ?>">实践积分审核</a>
                </td>
...
$(function(){
	...
	$('.edit').on('click',function(){
		window.location.href = '/tp/index.php?s=/Admin/Teacher/shenhe_students';
	});
});
